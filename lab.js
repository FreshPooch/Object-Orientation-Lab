...
//Code here
favoriteThings.car = 'Forester'; 
favoriteThings.show = 'himym'; 
...
favoriteThings.book = 'Percy Jackson'
console.log(favoriteThings); 
...
function ingredients(obj) {
  let {carb, protein, fat} = nutrients; 
  let array = []; 
  for(key in nutrients){
    array.push(nutrients[key]); 
  }
  return array; 
}
...
const jekyll = new Cat('jekyll', 5, 'black'); 
console.log(jekyll.name); 
...
const harry = new Wizard('Harry', 23, 'invisible'); 
harry.castSpell(); 
...
//Code Here
const iPhone = new Phone('apple', '10', 16, 'white', 800); 
const galaxy = new Phone('samsung', '2', 20, 'black', 500); 
const natesSadPhone = new Phone('motorola', 'g6', 8, 'black', 80); 
/* 
...
//Code Here
const myFirstVehicle = new Vehicle(5, 'black', 80000); 
...
//Code Here 
myFirstMotorcycle = new Motorcycle (3, 'black', 30000, 'Harley Davidson', true); 
...
//Code Here
const myFirstBoat = new Boat(10, 'white', 40000, 'LilDicky', 'yacht', false); 
/*
